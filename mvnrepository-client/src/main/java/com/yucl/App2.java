...
public class App2 {
    public static void main(String[] args) {
        ...
        //String uri = "https://central.sonatype.com/artifact/com.alibaba/fastjson/2.0.26/overview";
        String uri="https://search.maven.org/solrsearch/select?q=g:com.google.inject&rows=20&wt=json";
