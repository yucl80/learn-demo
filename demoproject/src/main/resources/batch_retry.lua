...
if available_slots>0 and rt_queue_length == 0 then
    -- 获取队列中的前 available_slots 个任务
    local queue_front = redis.call('LRANGE', batch_queue_name, -available_slots, -1)
    ...
    if found_in_queue then
        ...
        redis.call('LREM', batch_queue_name, 1, task_id)
