...
public class FernflowerDecompileExample implements IBytecodeProvider, IResultSaver {
    ...
    @SuppressWarnings("UseOfSystemOutOrSystemErr")
    public FernflowerDecompileExample(File destination, Map<String, Object> options) {
        this(destination, options, new PrintStreamLogger(System.out));
    }

    protected FernflowerDecompileExample(File destination, Map<String, Object> options, IFernflowerLogger logger) {
        root = destination;
